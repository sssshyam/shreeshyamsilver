        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="container-custom py-16">
                <div className="grid lg:grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <div className="space-y-8">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="font-semibold mb-2 text-lg">Visit Our Showroom</h3>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-silver-600 mb-1">Mon-Sat from 10am to 8pm</p>
                                    <a href="tel:+918504047243" className="text-accent hover:underline text-lg font-medium">
                                        +91 85040 47243
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-silver-600 mb-1">We'll respond within 24 hours</p>
                                    <a href="mailto:shreeshyamsilvernokha@gmail.com" className="text-accent hover:underline text-lg font-medium">
                    ...
                    {/* Map */}
                    <div className="h-full min-h-[400px] bg-silver-100 rounded-lg overflow-hidden shadow-lg border border-silver-200">
                        <iframe

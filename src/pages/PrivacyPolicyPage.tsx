                ...
                <div className="max-w-4xl mx-auto prose prose-lg">
                    <section className="mb-8">
                        ...
                        <p className="text-silver-700 leading-relaxed mb-4">
                            At Luxury Silver, we are committed to protecting your privacy and ensuring the security of your personal information.
                    ...
                    <section className="mb-8">
                        <h2 className="text-2xl font-serif font-semibold mb-4">Information Security</h2>
                        <p className="text-silver-700 leading-relaxed mb-4">

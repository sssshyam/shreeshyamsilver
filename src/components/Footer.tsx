            ...
            <div className="container-custom py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link to="/about" className="text-silver-200 hover:text-white transition-colors">
                                    About Us
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link to="/privacy-policy" className="text-silver-200 hover:text-white transition-colors">
                                    Privacy Policy
                                </Link>
                            </li>
                            <li>
                                <Link to="/terms" className="text-silver-200 hover:text-white transition-colors">
                                    Terms & Conditions
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-silver-200">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <a href="tel:+918504047243" className="hover:text-white transition-colors">
                                    +91 85040 47243
                                </a>
                            </li>
                            <li className="flex items-center gap-3">
                                ...
                                <a href="mailto:shreeshyamsilvernokha@gmail.com" className="hover:text-white transition-colors break-all">

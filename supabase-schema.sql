...
(
  ...
  'Handcrafted pure silver pooja thali with intricate traditional designs. Perfect for daily worship and special ceremonies.',
  45000,
  1,
...
(
  ...
  'Discover the ancient wisdom behind using pure silver utensils and their modern health benefits.',
  'Silver has been used for centuries in Indian households, not just for its beauty but for its remarkable health properties. Pure silver utensils have natural antibacterial properties that help keep food fresh and safe. Studies have shown that silver ions can eliminate harmful bacteria and boost immunity. In this article, we explore the science behind silver''s health benefits and why our ancestors valued it so highly.',
